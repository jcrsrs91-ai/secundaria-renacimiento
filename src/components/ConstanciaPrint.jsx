        ...
        */}
        <div className={`bg-white text-slate-800 font-serif text-justify relative z-10 watermark 
          ${type === 'terminacion' ? 'px-10 py-6 leading-relaxed' : 
            ...
            type === 'simple' ? 'px-16 py-12 leading-loose' : 'px-10 py-6 leading-relaxed'}`} 
          style={{ fontSize: type === 'calificaciones' ? '10pt' : (type === 'acreditacion_extraordinario' && Array.isArray(extraordinarioSelected) && extraordinarioSelected.length > 2) ? '10.5pt' : type === 'simple' ? '14pt' : '11pt' }}>
         ...
         <div className={`text-right font-bold uppercase text-[11pt] ${type === 'calificaciones' ? 'mb-4' : type === 'acreditacion_extraordinario' ? 'mb-2' : type === 'simple' ? 'mb-12' : 'mb-6'}`}>
            <p className={`${type === 'simple' ? 'text-[13pt]' : ''}`}>ASUNTO: CONSTANCIA DE ESTUDIOS {type === 'calificaciones' && 'CON CALIFICACIONES'}</p>
            
            {/* LEYENDA OFICIAL DEL AÑO */}
            <p className={`${type === 'acreditacion_extraordinario' ? 'mt-2' : type === 'simple' ? 'mt-8' : 'mt-4'} text-center font-bold text-[9pt] uppercase tracking-widest text-slate-500`}>
               {config?.leyendaOficial || '"2026, Año de Margarita Maza"'}
            </p>

            <p className={`${type === 'acreditacion_extraordinario' ? 'mt-2' : type === 'simple' ? 'mt-12' : 'mt-4'} ${type === 'simple' ? 'text-[14pt]' : 'text-[12pt]'} normal-case font-normal text-left`}>A quien corresponda:</p>
         </div>

         <p className={`${type === 'acreditacion_extraordinario' ? 'mb-3' : type === 'simple' ? 'mb-12' : 'mb-6'} indent-12`}>
         ...
         <div className={`text-center ${type === 'acreditacion_extraordinario' ? 'mb-3' : type === 'simple' ? 'mb-12' : 'mb-6'} font-black ${type === 'simple' ? 'text-2xl' : 'text-lg'} tracking-[0.3em] uppercase`}>
            C E R T I F I C A
         </div>
         ...
         {type === 'terminacion_tramite' ? (
           ...
           <p className={`${type === 'simple' ? 'mb-16' : 'mb-6'} indent-12`}>
         ...
         {type === 'terminacion' ? (
           ...
           <p className={`indent-12 ${type === 'calificaciones' || type === 'acreditacion_extraordinario' ? 'mb-2' : type === 'simple' ? 'mb-24' : 'mb-6'}`}>
         ...
         <div className={`text-center relative ${type === 'calificaciones' || type === 'acreditacion_extraordinario' ? 'mt-2' : type === 'simple' ? 'mt-20' : 'mt-6'}`}>
