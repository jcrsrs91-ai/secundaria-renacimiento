        ...
        */}
        <div className={`bg-white text-slate-800 font-serif text-justify relative z-10 watermark 
         ...
         {type === 'terminacion_tramite' ? (
           ...
           <p className={`${type === 'simple' ? 'mb-8' : type === 'promedio_anterior' ? 'mb-8 leading-[2]' : 'mb-6'} indent-12`}>
         ...
         {type === 'terminacion' ? (
           ...
           <p className={`indent-12 ${type === 'calificaciones' || type === 'acreditacion_extraordinario' ? 'mb-2' : type === 'simple' ? 'mb-10' : type === 'promedio_anterior' ? 'mb-12 leading-[2]' : 'mb-6'}`}>
         ...
         <div className={`text-center relative ${type === 'calificaciones' || type === 'acreditacion_extraordinario' ? 'mt-2' : type === 'simple' ? 'mt-10' : type === 'promedio_anterior' ? 'mt-12' : 'mt-6'}`}>
