      ...
      <div className="print-container bg-white text-black mx-auto p-4 shadow-2xl print:shadow-none print:p-0 flex flex-col" style={{ maxWidth: '21.59cm', minHeight: '27.94cm', boxSizing: 'border-box' }}>
        ...
        <div className="flex justify-between items-center border-b-2 border-black pb-2 mb-2">
          ...
          <div className="w-20 flex flex-col items-center justify-center">
            {/* Espacio para Foto */}
            <div className="w-20 h-24 border-2 border-gray-400 flex items-center justify-center text-xs text-gray-500 text-center overflow-hidden">
              {data.fotoUrl ? (
        ...
        <div className="mb-2">
          <h4 className="font-bold text-sm uppercase bg-gray-800 text-white px-2 py-0.5 mb-0.5">1. Datos Académicos</h4>
          <div className="grid grid-cols-6 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-sm uppercase bg-gray-800 text-white px-2 py-0.5 mb-0.5">2. Datos Personales del Alumno</h4>
          <div className="grid grid-cols-4 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 mb-0.5 leading-tight">
          ...
          <div className="grid grid-cols-5 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-sm uppercase bg-gray-800 text-white px-2 py-0.5 mb-0.5">3. Antecedentes Escolares y Becas</h4>
          <div className="grid grid-cols-6 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 leading-tight bg-gray-50">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-sm uppercase bg-gray-800 text-white px-2 py-0.5 mb-0.5">4. Información Médica de Urgencia</h4>
          <div className="grid grid-cols-4 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-sm uppercase bg-gray-800 text-white px-2 py-0.5 mb-0.5">5. Tutor y Contactos de Emergencia</h4>
          <div className="grid grid-cols-3 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 mb-0.5 leading-tight">
          ...
          <div className="grid grid-cols-2 gap-x-2 gap-y-1 text-xs border border-gray-300 px-2 py-1.5 bg-gray-50 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-sm uppercase bg-gray-800 text-white px-2 py-0.5 mb-0.5">6. Acuse de Documentación Recibida</h4>
          <div className="border border-gray-300 px-2 py-1.5 text-xs leading-tight">
            <p className="mb-1.5 text-gray-600 font-bold text-[11px]">Marque con una 'X' si el documento fue entregado físicamente para cotejo o si fue detectado en sistema:</p>
            <div className="grid grid-cols-1 gap-1 mb-2 font-medium text-xs">
            ...
            <div className="flex border-t border-gray-200 pt-1.5">
        ...
        {hasMissingDocs && (
          <div className="mb-2 mt-2 px-3 text-[10px] border border-gray-400 p-2 bg-gray-50 text-justify leading-tight">
        ...
        <div className="mt-auto">
          ...
          <div className="mt-8 grid grid-cols-3 gap-6 text-center text-xs px-6">
            <div>
              ...
              <p className="text-[10px] text-gray-700 mt-1 leading-tight">Padre, Madre o Tutor Legal</p>
            </div>
            <div>
              <div className="border-t-2 border-black pt-1 w-full mx-auto font-bold uppercase truncate">
                {data.nombres} {data.apellidoPaterno} {data.apellidoMaterno}
              </div>
              <p className="text-[10px] text-gray-700 mt-1 leading-tight">Firma del Alumno(a)</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-[10px] text-gray-700 mt-1 leading-tight">Sello y Firma de Autorización<br/>(Director del Plantel)</p>
            </div>
          </div>

          <div className="text-center text-[10px] text-gray-500 border-t border-gray-300 pt-1.5 mt-4 mx-6">
