...
export default function HojaInscripcionPrint({ data }) {
  ...
  const concepto = isNuevoIngreso 
    ? "Aportación institucional para paquete de Credencial Escolar Oficial y Folders Administrativos."
    : "Aportación institucional para revalidación de identificación oficial.";
  const descripcion = isNuevoIngreso
    ? "El presente recibo ampara el pago correspondiente a la emisión de la Credencial Escolar Oficial del alumno, así como el paquete de folders y papelería requeridos para la integración, resguardo y manejo de su expediente académico en los departamentos de Administración Escolar."
    : "El presente recibo ampara el pago correspondiente a la emisión y/o revalidación de la Credencial Escolar Oficial del alumno, documento indispensable para el control de accesos, seguridad institucional y procesos de prefectura durante el ciclo escolar vigente.";
  ...
  return (
    <div>
      ...
      <div className="print-container bg-white text-black mx-auto p-4 shadow-2xl print:shadow-none print:p-0" style={{ maxWidth: '21.59cm', height: '27.94cm', boxSizing: 'border-box', position: 'relative' }}>
        ...
        <div className="flex justify-between items-center border-b-2 border-black pb-2 mb-2">
          ...
          <div className="text-center flex-1 px-2">
            ...
            <p className="text-[10px] font-bold mt-1 bg-gray-200 inline-block px-2 py-0.5 rounded border border-gray-400 uppercase">
              FICHA INDIVIDUAL DE {data.tipoTramite || 'INSCRIPCI"N'}
            </p>
          </div>
          <div className="w-16 flex flex-col items-center justify-center">
            {/* Espacio para Foto */}
            <div className="w-16 h-20 border-2 border-gray-400 flex items-center justify-center text-[10px] text-gray-500 text-center overflow-hidden">
              {data.fotoUrl ? (
        ...
        <div className="mb-2">
          <h4 className="font-bold text-[11px] uppercase bg-gray-800 text-white px-1.5 py-0.5 mb-0.5">1. Datos Académicos</h4>
          <div className="grid grid-cols-5 gap-1 text-[11px] border border-gray-300 p-1 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-[11px] uppercase bg-gray-800 text-white px-1.5 py-0.5 mb-0.5">2. Datos Personales del Alumno</h4>
          <div className="grid grid-cols-4 gap-1 text-[11px] border border-gray-300 p-1 mb-1 leading-tight">
          ...
          <div className="grid grid-cols-4 gap-1 text-[11px] border border-gray-300 p-1 leading-tight">
          ...
          <div className="grid grid-cols-4 gap-1 text-[11px] border border-gray-300 border-t-0 p-1 mb-1 leading-tight">
            <div className="col-span-4"><span className="font-bold text-gray-600">Beca:</span> <br/><span className="font-semibold uppercase">{(data.tieneBeca && data.tieneBeca.toUpperCase().startsWith("S")) ? (data.nombreBeca ? data.tieneBeca + " - " + data.nombreBeca : data.tieneBeca) : (data.tieneBeca || "NO")}</span></div>
          </div>
        </div>

        {/* Sección 3: Escuela de Procedencia */}
        <div className="mb-2">
          <h4 className="font-bold text-[11px] uppercase bg-gray-800 text-white px-1.5 py-0.5 mb-0.5">3. Antecedentes Escolares</h4>
          <div className="grid grid-cols-5 gap-1 text-[11px] border border-gray-300 p-1 leading-tight bg-gray-50">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-[11px] uppercase bg-gray-800 text-white px-1.5 py-0.5 mb-0.5">4. Información Médica de Urgencia</h4>
          <div className="grid grid-cols-4 gap-1 text-[11px] border border-gray-300 p-1 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-[11px] uppercase bg-gray-800 text-white px-1.5 py-0.5 mb-0.5">5. Tutor y Contactos de Emergencia</h4>
          <div className="grid grid-cols-3 gap-1 text-[11px] border border-gray-300 p-1 mb-1 leading-tight">
          ...
          <div className="grid grid-cols-2 gap-1 text-[11px] border border-gray-300 p-1 bg-gray-50 leading-tight">
        ...
        <div className="mb-2">
          <h4 className="font-bold text-[11px] uppercase bg-gray-800 text-white px-1.5 py-0.5 mb-0.5">6. Acuse de Documentación Recibida</h4>
          <div className="border border-gray-300 p-1.5 text-[10px] leading-tight">
            ...
            <div className="grid grid-cols-1 gap-1 mb-2 font-medium text-[10px]">
        ...
        {hasMissingDocs && (
          <div className="mb-2 mt-2 px-2 text-[10px] border border-gray-400 p-1.5 bg-gray-50 text-justify leading-tight">
            <span className="font-bold">CARTA COMPROMISO DE ENTREGA DE DOCUMENTACI"N:</span> El que suscribe, en su carácter de Padre, Madre o Tutor del alumno(a), al no contar con la totalidad de los requisitos en este momento, se compromete formalmente a entregar en la Dirección de la escuela la documentación faltante o pendiente indicada en el presente acuse, a más tardar el último día hábil del mes de septiembre del ciclo escolar en curso.
          </div>
        )}

        {/* Firmas */}
        <div className="mt-8 grid grid-cols-3 gap-6 text-center text-[11px] px-4">
          <div>
            ...
            <p className="text-[10px] text-gray-700 mt-0.5">Padre, Madre o Tutor Legal</p>
          </div>
          <div>
            <div className="border-t border-black pt-1 w-full mx-auto font-bold uppercase truncate">
              {data.nombres} {data.apellidoPaterno} {data.apellidoMaterno}
            </div>
            <p className="text-[10px] text-gray-700 mt-0.5">Firma del Alumno(a)</p>
          </div>
          <div className="text-center pt-2">
            ...
            <p className="text-[10px] text-gray-700 mt-0.5">Sello y Firma de Autorización<br/>(Director del Plantel)</p>
          </div>
        </div>
