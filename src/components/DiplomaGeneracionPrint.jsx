              ...
              <div className="relative z-10 w-full h-full flex flex-col items-center justify-between">
                ...
                <div className="max-w-4xl text-center px-4 mt-2">
                  <p className="text-[12pt] text-navy leading-normal font-medium font-montserrat">
                    En reconocimiento a su <strong className="font-bold">brillante desempeño académico</strong>, <strong className="font-bold">dedicación</strong> y <strong className="font-bold">esfuerzo constante</strong> durante los tres años de su educación secundaria (Generación <strong className="font-bold">{generacion}</strong>). 
                    Su resiliencia ante los desafíos y su <strong className="font-bold">conducta ejemplar</strong> le han hecho merecedor del <strong className="font-bold">más alto reconocimiento</strong> de nuestra institución.
                  </p>
                ...
                {/* Fecha */}
                <div className="w-full flex justify-end px-12 mt-0 mb-6 relative z-20">
                  <p className="text-[10px] text-slate-500 font-medium text-right relative -top-4">
