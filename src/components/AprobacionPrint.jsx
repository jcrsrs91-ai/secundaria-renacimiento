    ...
    const renderRow = (label, row, isTotal = false) => {
      ...
      return (
        <tr key={label} className={`text-center ${isTotal ? 'bg-indigo-50 font-bold border-t-2 border-indigo-200' : 'border-b border-slate-100 hover:bg-slate-50'}`}>
          <td className="py-2 px-1 font-bold text-slate-700 print:py-[2px]">{label}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.extH}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.extM}</td>
          <td className="py-2 px-1 font-bold text-slate-800 bg-slate-50 print:bg-transparent print:py-[2px]">{row.extT}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.regH}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.regM}</td>
          <td className="py-2 px-1 font-bold text-emerald-600 bg-emerald-50/50 print:bg-transparent print:py-[2px]">{row.regT}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.irr1}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.irr2}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.irr3}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.irr4}</td>
          <td className="py-2 px-1 font-bold text-amber-600 bg-amber-50/50 print:bg-transparent print:py-[2px]">{row.irrT}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.noaH}</td>
          <td className="py-2 px-1 print:py-[2px]">{row.noaM}</td>
          <td className="py-2 px-1 font-bold text-red-600 bg-red-50/50 print:bg-transparent print:py-[2px]">{row.noaT}</td>
          <td className={`py-2 px-1 print:py-[2px] font-bold ${row.irrT + row.noaT > 0 ? 'text-red-500' : 'text-emerald-500'}`}>{pct}</td>
          <td className={`py-2 px-1 print:py-[2px] font-bold ${comprobacion === row.extT ? 'text-slate-700' : 'text-red-600'}`}>{comprobacion}</td>
        </tr>
      );
    };
          ...
          <table className="w-full text-sm print:text-[9px]">
            <thead>
              <tr className="bg-slate-800 text-white font-semibold">
                <th rowSpan="2" className="py-2 px-1 print:py-[2px] rounded-tl-lg print:rounded-none">Grupo</th>
                <th colSpan="3" className="py-2 px-1 print:py-[2px] border-x border-slate-700">Existencia (Inscritos)</th>
                <th colSpan="3" className="py-2 px-1 print:py-[2px] border-r border-slate-700 bg-emerald-800">Alumnos Regulares</th>
                <th colSpan="5" className="py-2 px-1 print:py-[2px] border-r border-slate-700 bg-amber-700">Adeudan Disciplinas (Irregulares)</th>
                <th colSpan="3" className="py-2 px-1 print:py-[2px] border-r border-slate-700 bg-red-800">No Acreditados (5+)</th>
                <th rowSpan="2" className="py-2 px-1 print:py-[2px] border-r border-slate-700 w-16">% Rep.</th>
                <th rowSpan="2" className="py-2 px-1 print:py-[2px] rounded-tr-lg print:rounded-none w-16">Comp.</th>
              </tr>
              <tr className="bg-slate-700 text-white font-medium text-xs print:text-[8px]">
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600">H</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600">M</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-800 font-bold text-slate-200">T</th>
                
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-emerald-700">H</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-emerald-700">M</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-800 bg-emerald-700 font-bold text-emerald-100">T</th>
                
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-amber-600">1</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-amber-600">2</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-amber-600">3</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-amber-600">4</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-800 bg-amber-600 font-bold text-amber-100">T</th>
                
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-red-700">H</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-600 bg-red-700">M</th>
                <th className="py-1 px-1 print:py-[1px] border-r border-slate-800 bg-red-700 font-bold text-red-100">T</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div className="bg-white max-w-6xl mx-auto p-10 rounded-2xl shadow-xl print:shadow-none print:p-0 print:rounded-none">
        ...
        <div className="flex items-center justify-between mb-8 border-b-2 border-slate-200 pb-6 print:border-slate-300 print:pb-1 print:mb-2">
          ...
          <div className="text-center flex-1 px-4">
            <h1 className="text-2xl font-black text-slate-900 tracking-tight uppercase print:text-sm print:leading-tight">ESTADÍSTICA DE APROBACIÓN (FORMATO E2)</h1>
            ...
            <p className="text-sm font-medium text-slate-500 mt-1 print:text-[9px] print:mt-0 print:leading-tight">Ciclo Escolar 2025-2026 • Cierre del 3er Periodo</p>
          </div>
          <img src="/logo-escuela.png" alt="Escuela" className="h-20 w-auto object-contain print:h-10" />
        </div>

        {/* Tarjetas de Resumen Global */}
        <div className="grid grid-cols-4 gap-4 mb-10 print:gap-1 print:mb-2 break-inside-avoid">
          {/* Total Evaluados */}
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 shadow-sm flex flex-col justify-center print:border print:border-slate-300 print:shadow-none print:p-1.5">
            <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1 print:text-[8px] print:mb-0">Alumnos Evaluados</p>
            <p className="text-3xl font-black text-slate-800 print:text-base">{totalGeneral.extT}</p>
            <div className="flex gap-2 mt-2 text-xs font-semibold text-slate-500 print:text-[7px] print:mt-0">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 shadow-sm flex flex-col justify-center print:border print:border-emerald-300 print:shadow-none print:p-1.5">
            <p className="text-xs font-bold text-emerald-700 uppercase tracking-wider mb-1 print:text-[8px] print:mb-0">Índice de Aprobación</p>
            ...
            <p className="mt-1 text-xs font-semibold text-emerald-600 print:text-[7px] print:mt-0">{totalGeneral.regT} Alumnos Regulares</p>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 shadow-sm flex flex-col justify-center print:border print:border-amber-300 print:shadow-none print:p-1.5">
            <p className="text-xs font-bold text-amber-700 uppercase tracking-wider mb-1 print:text-[8px] print:mb-0">Riesgo (1 a 4 Materias)</p>
            <div className="flex items-baseline gap-2">
            ...
            <p className="mt-1 text-xs font-semibold text-amber-600 print:text-[7px] print:mt-0">{totalGeneral.irrT} Alumnos Irregulares</p>
          </div>
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 shadow-sm flex flex-col justify-center print:border print:border-red-300 print:shadow-none print:p-1.5">
            <p className="text-xs font-bold text-red-700 uppercase tracking-wider mb-1 print:text-[8px] print:mb-0">No Acreditados (5+)</p>
            <div className="flex items-baseline gap-2">
            ...
            <p className="mt-1 text-xs font-semibold text-red-600 print:text-[7px] print:mt-0">{totalGeneral.noaT} Alumnos Repetidores</p>
          </div>
        </div>
        ...
        <div className="mt-8 mb-4 break-inside-avoid print:mt-2 print:mb-2">
          <h3 className="text-xl font-black text-slate-800 mb-3 border-b-2 border-slate-800 pb-1 uppercase print:text-xs print:mb-1 print:border-slate-800">TOTAL ESCUELA</h3>
          <div className="bg-indigo-600 text-white rounded-xl p-4 shadow-md flex justify-around text-center print:bg-slate-800 print:p-1.5 print:rounded-lg">
            <div>
              <p className="text-xs text-indigo-200 font-bold uppercase tracking-wide print:text-[7px]">Inscritos</p>
              <p className="text-2xl font-black print:text-base">{totalGeneral.extT}</p>
            </div>
            <div>
              <p className="text-xs text-emerald-300 font-bold uppercase tracking-wide print:text-[7px]">Regulares</p>
              <p className="text-2xl font-black print:text-base">{totalGeneral.regT}</p>
            </div>
            <div>
              <p className="text-xs text-amber-300 font-bold uppercase tracking-wide print:text-[7px]">Irregulares</p>
              <p className="text-2xl font-black print:text-base">{totalGeneral.irrT}</p>
            </div>
            <div>
              <p className="text-xs text-red-300 font-bold uppercase tracking-wide print:text-[7px]">Repetidores</p>
