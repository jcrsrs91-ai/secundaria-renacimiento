...
export default function ConstanciaEERPrint({ student, regularizadas = [], adeudos = [] }) {
  ...
  // Hardcoded DOS MIL VEINTICINCO, DOS MIL VEINTISÉIS etc.
    ...
    <div className= bg-white text-black font-sans relative style={{ width: '21.59cm', minHeight: '27.94cm', padding: '1cm 1.5cm' }}>
      ...
      <div className=print-content>
        ...
        <div className=flex justify-between text-center text-[10px] mb-8 font-bold mt-12>
          ...
          <div className=w-[45%]>
            <div className=mb-2>Vo. Bo.</div>
            <div>JEFE(A) DE CONTROL ESCOLAR</div>
            <div className=mt-12 border-t border-black pt-1 px-4 uppercase>{config?.controlEscolar || 'Profr. Bernardo Hernández Gómez'}</div>
            <div className=font-normal>NOMBRE, FIRMA Y SELLO</div>
          </div>
        </div>
